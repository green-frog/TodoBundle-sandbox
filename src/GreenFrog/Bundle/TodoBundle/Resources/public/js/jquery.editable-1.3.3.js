...
$.fn.editable = function(options){
	...
	options.toEditable = function(){
		...
		if(opts.submit){
			...
			//- GreenFrog Hook : Adding enter keypress when @ text
                        $this.bind('keypress',function(e){if(e.keyCode == 13) {opts.toNonEditable($(this),true)}})
				 .children()
				 	.bind('keypress',function(e){if(e.keyCode == 13) {opts.toNonEditable($(this).parent(),true)}});
                }
		// Cancel Event
		if(opts.cancel)
			$('<button/>').appendTo($this)
